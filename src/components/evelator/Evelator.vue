<template>
  <div class="evelator">
    <router-link to="/header/customized"
                 tag="div"
                 class="first">
    ...
    <div>
      <a href="javascript:void(0)"
        ...
        <div class="introduce last">
          <p class="oursImg">
            <img src="https://img2.baidu.com/it/u=1790834130,1952230725&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500"
                 alt="">
          </p>
    ...
    <span class="backTop"
          @click="turnup"
          v-show="toback"><img src="../../assets/image/topTop.png"
           alt=""></span>
  </div>
</template>
