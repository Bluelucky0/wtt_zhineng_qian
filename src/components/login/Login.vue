  ...
  <div class="loginback">
    <div class="logincontent">
      <img src="../../assets/image/close.png"
           ...
           class="close"
           @click="closelogin">
      <p class="login_title"><span>武夷智能旅游网</span> 登录</p>
      <p class="login_intro">登录武夷智能旅游网，寻找合适的旅游景区</p>
      <div class="input ">
        <label for="">账号：</label>
        <input type="text"
               v-model="count"
    ...
    userlogin () {
      ...
      this.$axios.post('/travel/login', loginParam).then(res => {
        if (res.data) {
          ...
          this.$layer.msg(res.data.msssage)
          localStorage.setItem('users', JSON.stringify(res.data.data))
          this.closelogin()
          this.reload()
          this.$router.push({ name: 'main', query: { label: this.labels } })
        }
      })
    }
  },
