    ...
    <div class="contence">
      ...
      <div class="needs">
        <div class="neddEach">
          ...
          <textarea name=""
                    v-model="huanjing"
                    placeholder="请输入您期望的地理环境"></textarea>
        </div>
        <div class="neddEach">
          <label for="">饮食文化</label>
          <textarea name=""
                    v-model="yinshi"
                    placeholder="请输入您期望的饮食文化"></textarea>
        </div>
        <div class="neddEach">
          <label for="">交通情况</label>
          <textarea name=""
                    v-model="jiaotong"
                    placeholder="请输入您期望的交通情况"></textarea>
        </div>
        <div class="neddEach">
          <label for="">兴趣爱好</label>
          <textarea name=""
                    v-model="aihao"
                    placeholder="请输入您期望的兴趣爱好"></textarea>
        </div>
        <div class="neddEach">
          <label for="">周边设施</label>
          <textarea name=""
                    v-model="sheshi"
                    placeholder="请输入您期望的周边设施（酒店，餐饮等）"></textarea>
        </div>
        <div class="neddEach">
          <label for="">消费水平</label>
          <textarea name=""
                    v-model="xiaofei"
                    placeholder="请输入您期望的消费水平"></textarea>
        </div>
        <div class="tijiao"
             @click="tijiao">提交</div>
      </div>
  ...
  methods: {
    ...
    tijiao () {
      ...
      if (!this.huanjing && !this.yinshi && !this.jiaotong && !this.aihao && !this.sheshi && !this.xiaofei) {
        this.$layer.msg('请输入至少一项您期望的景区要求');
      } else {
