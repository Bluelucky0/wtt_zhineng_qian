<template>
  <div class="containers"
       :class="{'sharecontain':sharecontain}">
    <div class="header"
         :class="{'newheader':newheader,'scrollheader':scrollheader}">
      <div class="content">
        <div class="mainleft">
          <span class="logo">武夷智能旅游网 欢迎您</span>
          <ul class="navlist">
            <li>
            ...
            <li>
              <router-link to="/header/message">游记攻略</router-link>
            </li>
            <li>
            ...
            <li>
              <router-link to="/header/platform">关于我们</router-link>
            </li>
          </ul>
        </div>
        <div class="login_register">
          <div class="searchdetails">
            <input type="text"
                   class="search"
                   placeholder="请输入景区关键字"
                   v-model="cansearch"
                   @keypress="keytosearch">
          ...
          <div class="allregister"
            ...
            <router-link to="/register"
                         class="register"
                         tag="span">注册</router-link>
          </div>
          <div class="has_login"
               :class="{loginlist:loginxiala}"
               v-show="login === false"
            ...
            <img v-if="users"
                 ...
                 alt=""
                 onerror="this.src='../assets/image/header.jpg'">
            <!-- 消息下拉 -->
            <ul class="listxiala"
                v-show="showlist">
              <li><a active-class='active'
                   @click.prevent="tomine">编辑信息</a></li>
              <li><a active-class='active'
                   @click.prevent="toadvice">留言反馈</a></li>
              <li><a href="#"
                   @click.prevent="exitlogin()">退出登录</a></li>
            </ul>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    exitlogin () {
      ...
      this.$router.push('/header/main')
      this.reload()
    },
    dosearch () {
      if (this.cansearch) {
        this.$router.push({ name: 'recoment', query: { gosearch: this.cansearch } })
        this.cansearch = ''
      }
    },
    keytosearch (e) {
