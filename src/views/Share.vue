    ...
    <div class="contence">
      ...
      <div class="messages"
        ...
        <div class="shraetop">
          ...
          <div class="towrite"
               @click="jumpwriteshare"><span class="iconfont icon-edit"></span>写游记</div>
        </div>
        <ul class="messageEach">
          ...
          <ul class="lis">
            <li v-for="(item,index) in hotData"
              ...
              <div class="list-show">
                <a href="http://www.tuniu.com/trips/31369802"
                   target="_blank"
                   rel="nofollow">
                  <div class="list-name">#热门游记——# {{item.name}}</div>
                  <div class="list-des">{{item.introduction}}</div>
                </a>
                <div class="list-auther">
                  <div class="list-auther-left">
                    ...
                    <div class="list-auther">春水</div>
                    <div class="list-auther"><i class="el-icon-view"></i>{{item.hot}} &nbsp;</div>
                    <div class="list-auther"><i class="el-icon-coffee"></i>8 &nbsp;</div>
                  </div>
                </div>
              </div>
            </li>
...
export default {
  ...
  mounted () {
    // this.share()
    // 热门游记
    this.$axios.get('/travel/getTravelByHot').then(res => {
      console.log(res);
      if (res.data) {
